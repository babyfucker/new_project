...
//    int find(string s, int begin, int& exist) {
//        if(s.size() == 0) {
...
//                return -1;
//        }
//        if (begin == s.size() - 1 && map.find(s) != map.end()) {
//            exist = map[s];
//            return exist;
//        }
//        for (int i = begin; i < s.size(); i++) {
//            swap(s[begin], s[i]);
//            find(s, begin + 1, exist);
//            if (exist >= 0) {
//                break;
//            }
//            swap(s[begin], s[i]);
...
//        int a = 0;
//        map[strs[0]] = a;
//        vector<string> ans1(1,strs[0]);
//        answer.push_back(ans1);
//        for (int i = 1; i < strs.size(); i++) {
//            int exist = -1;
//            int f = find(strs[i], 0, exist);
//            if (f >= 0) {
//                map[strs[i]] = f;
//                answer[f].push_back(strs[i]);
//            } else {
//                map[strs[i]] = ++a;
